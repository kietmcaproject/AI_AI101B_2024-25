...
def predict():
    ...
    return render_template('result.html', favicon_ico=favicon_ico, location=data['Location'],predictions=predictions,avg_predicted_price=avg_predicted_price,bg_image_=bg_image_)
